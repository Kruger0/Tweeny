...
if (point_in_rectangle(mouse_x, mouse_y, _x1, _y1, _x2, _y2)) {
    if (!hovered) {
        ...
        tween.Color(id,"btnColor", #FFFFFF, 0.2).SetEase(TWEEN_EASE_EXPO, TWEEN_CHANNEL_OUT);
        tween.Color(id,"lblColor", #FF4040, 0.2).SetEase(TWEEN_EASE_EXPO, TWEEN_CHANNEL_OUT);
    }
} else {
    if (hovered) {
        hovered = false;
        ...
        tween.Color(id,"btnColor", #00CDF9, 0.2).SetEase(TWEEN_EASE_EXPO, TWEEN_CHANNEL_OUT);
        tween.Color(id,"lblColor", #101010, 0.2).SetEase(TWEEN_EASE_EXPO, TWEEN_CHANNEL_OUT);
    }
}
...
if (hovered) {
    if (mouse_check_button_pressed(mb_left)) {
        ...
        tween.Color(id,"btnColor", #FFFFFF, 0).SetEase(TWEEN_EASE_EXPO, TWEEN_CHANNEL_OUT);
        tween.Color(id,"lblColor", #FF4040, 0).SetEase(TWEEN_EASE_EXPO, TWEEN_CHANNEL_OUT);
    }
}